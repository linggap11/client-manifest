 ...
 */ !(function (e) {
    ...
    (e.fn.fileinputLocales = {}),
        ...
        e.fn.fileinputBsVersion || (e.fn.fileinputBsVersion = (window.Alert && window.Alert.VERSION) || (window.bootstrap && window.bootstrap.Alert && bootstrap.Alert.VERSION) || "3.x.x"),
        ...
        (i.prototype = {
            ...
            _init: function (i, a) {
                ...
                (s.options = i),
                    ...
                    void 0 === s.errorCloseButton && (s.errorCloseButton = t.closeButton("kv-error-close" + (t.isBs(5) ? "  float-end" : ""))),
                    ...
                    (i.fileManager = {
                        ...
                        getUploadStats: function (e, a, r) {
                            ...
                            return (
                                ...
                                (n = { fileId: e, started: l, elapsed: s, loaded: a, total: r, bps: o.bps, bitrate: i._getSize(o.bps, d), pendingBytes: u }),
                ...
                if (a.enableResumableUpload) {
                    ...
                    (i = a.resumableManager = {
                        ...
                        setAjaxError: function (e, t, o, l) {
                            e.responseJSON && e.responseJSON.error && (o = e.responseJSON.error.toString()), l || (i.error = o), r.showErrorLog && a._log(n.ajaxError, { status: e.status, error: o, text: e.responseText || "" });
                        },
                        reset: function () {
                            ...
                            (i.completed = !0),
                                ...
                                "success" === t
                                    ? ((o.uploadedSize += i.file.size),
                                      a.showPreview && (a._setProgress(101, c), a._setThumbStatus(d, "Success"), a._initUploadSuccess(i.chunksProcessed[s].data, d)),
                                      o.removeFile(s),
                                    ...
                                    : "cancel" !== t &&
                                      ...
                                      a.$errorContainer.find('li[data-file-id="' + p.fileId + '"]').length ||
                                          ((l = { file: i.fileName, max: r.maxRetries, error: i.error }),
                                          (n = a.msgResumableUploadRetriesExceeded.setTokens(l)),
                                          e.extend(p, l),
                                          a._showFileError(n, p, "filemaxretries"),
                                          f && (o.removeFile(s), delete i.chunksProcessed[s], o.isProcessed() && a._setProgress(101)))),
                        ...
                        upload: function () {
                            ...
                            e = setInterval(function () {
                                ...
                                if (
                                    (i.checkAborted(e),
                                    "new" === n && (a.lock(), (n = "processing"), (l = r.shift()), o.initStats(l), o.stack[l] && (i.init(l, o.stack[l], o.getIndex(l)), i.processUpload())),
                        ...
                        processUpload: function () {
                            ...
                            return r.testUrl
                                ? ((n = new FormData()),
                                  (l = o.stack[f]),
                                  a._setUploadData(n, { fileId: f, fileName: l.fileName, fileSize: l.size, fileRelativePath: l.relativePath, chunkSize: i.chunkSize, chunkCount: i.chunkCount }),
                                  (s = function (e) {
                                  ...
                                  void a._ajaxSubmit(s, d, u, c, n, f, i.fileIndex, r.testUrl))
                                ...
                                (v = new FormData()),
                                    ...
                                    (_ = function (t, d, c) {
                                        ...
                                        var p = a.uploadParamNames,
                                            ...
                                            m = [u, e, l, o, i, w];
                                        t.error
                                            ? (r.showErrorLog && a._log(n.retryStatus, { retry: l + 1, filename: i.fileName, chunk: e }), a._raise("filechunkerror", m), i.pushAjax(e, l + 1), (i.error = t.error), h(t.error))
                                            : ((i.logs[t[f]] = !0),
                                    ...
                                    (C = function (t, r, n) {
                                        return a._isAborted()
                                            ...
                                            : ((w = a._getOutData(v, t)), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, l, o, i, w]), i.pushAjax(e, l + 1), void h(g.resumableRetryError, { n: l - 1 }));
                                    }),
                                    (y = function () {
            ...
            _initTemplateDefaults: function () {
                ...
                (i =
                    ...
                    (l = '<div class="file-caption form-control {class}" {tabIndexConfig}>\n  <span class="file-caption-icon"></span>\n  <input readonly class="file-caption-name">\n</div>'),
                    (s = '<button type="{type}" title="{title}" class="{css}" {status} {tabIndexConfig}>{icon} {label}</button>'),
                    ...
                    (N = '<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>'),
                    ...
                    H._isPdfRendered() && ($ = H.pdfRendererTemplate.replace("{renderer}", H._encodeURI(H.pdfRendererUrl))),
                    (H.defaults = {
                        layoutTemplates: {
                            main1: i,
                            main2: a,
                        ...
                        previewContentTemplates: { generic: k, html: E, image: I, text: S, office: A, gdocs: D, video: z, audio: j, flash: U, object: M, pdf: $, other: R },
            ...
            _parseError: function (t, i, a, r) {
                ...
                return (
                    ...
                    s.showAjaxErrorDetails && l && (o ? (d = e.trim(o + "")) : ((l = e.trim(l.replace(/\n\s*\n/g, "\n"))), (n = l.length ? "<pre>" + l + "</pre>" : ""), (d += d ? n : l))),
            ...
            _getZoomButton: function (e) {
                ...
                return (
                    ("fullscreen" !== e && "borderless" !== e && "toggleheader" !== e) || (l += ' data-toggle="button" aria-pressed="false" autocomplete="off"'),
                    '<button type="button" class="' + r + " btn-kv-" + e + '"' + l + ">" + a + "</button>"
                );
            },
            ...
            _uploadSingle: function (i, a, r) {
                ...
                w.enableResumableUpload ||
                    (w.showPreview && ((o = b.getThumb(a)), (u = o.find(".file-thumb-progress")), (s = o.find(".kv-file-upload")), (d = o.find(".kv-file-remove")), u.show()),
                    0 === _ ||
                        !x ||
                        ...
                        (p = function (l) {
                            (n = w._getOutData(C, l)),
                                ...
                                e.extend(!0, F, n),
                                w._abort(F) && (l.abort(), r || (w._setThumbStatus(o, "New"), o.removeClass("file-uploading"), s.removeAttr("disabled"), d.removeAttr("disabled"), w.unlock()), w._setProgressCancelled());
                        }),
                        (g = function (l, d, p) {
                            ...
                            (n = w._getOutData(C, p, l)),
                                ...
                                setTimeout(function () {
                                    t.isEmpty(l) || t.isEmpty(l.error)
                                        ? (w.showPreview && (w._setThumbStatus(o, "Success"), s.hide(), w._initUploadSuccess(l, o, r), w._setProgress(101, u)),
                    ...
                    a.find(n).each(function () {
                        ...
                        if (!t.isEmpty(p) && void 0 !== f) {
                            ...
                            (y = parseInt(y.replace(t.INIT_FLAG, ""))),
                                ...
                                (m = e.extend(!0, {}, { url: i._encodeURI(p), type: "POST", dataType: "script", data: e.extend(!0, {}, { key: f }, b) }, i._ajaxDeleteSettings)),
            ...
            _getSize: function (t, i) {
                ...
                return e.isNumeric(t) && e.isNumeric(o)
                    ? ("function" == typeof l
                          ...
                          : 0 === o
                          ? (r = "0.00 B")
                          : (i || (i = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"]), (a = Math.floor(Math.log(o) / Math.log(1024))), (r = (o / Math.pow(1024, a)).toFixed(2) + " " + i[a])),
            ...
            _generatePreviewTemplate: function (i, a, r, n, o, l, s, d, c, u, p, f, g, m) {
                var h,
                    ...
                    S = E ? "other" : i;
                return (
                    (v = 400 > x ? b.previewSettingsSmall[S] || b.defaults.previewSettingsSmall[S] : b.previewSettings[S] || b.defaults.previewSettings[S]),
                    v &&
                    ...
                    b.fileActionSettings.showZoom && (C = w(I ? "other" : i, m ? m : a, !0, "kv-zoom-thumb")),
            ...
            _validateImageOrientation: function (i, a, r, n, o, l, s, d) {
                ...
                return p.canOrientImage
                    ? (i.css("image-orientation", g ? "from-image" : "none"), void p._validateImage(r, n, o, l, s, d, f))
                    : ((u = t.getZoomSelector(r, " img")),
                      (f = g ? p._getExifObj(d) : null),
                      (c = f ? f["0th"][piexif.ImageIFD.Orientation] : null)
                          ? (p.setImageOrientation(i, e(u), c, p._getFrame(r)), p._raise("fileimageoriented", { $img: i, file: a }), void p._validateImage(r, n, o, l, s, d, f))
            ...
            _getResizedImage: function (i, a, r, n) {
                ...
                try {
                    P.drawImage(v, 0, 0, w, b),
                        ...
                        S && ((p = window.piexif.dump(S)), (d = window.piexif.insert(p, d))),
                        (o = t.dataURI2Blob(d)),
            ...
            readFiles: function (i) {
                ...
                var a,
                    ...
                    v = function (t, n, o, l, s) {
                        var d,
                            c = e.extend(!0, {}, r._getOutData(null, {}, {}, i), { id: o, index: l, fileId: s }),
                        ...
                        var y,
                            ...
                            V = function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    r._raise("fileloaded", [j, M, U, w, n]) && r.isAjaxUpload ? e || C.add(j) : e && C.removeFile(U);
                            };
                        if (j) {
                            if (((I = C.getId(j)), g > 0)) for (x = 0; g > x; x++) (k = f[x]), (E = r.msgFileTypes[k] || k), (Z += 0 === x ? E : ", " + E);
                            ...
                            if ((t.isEmpty(m) || (O = new RegExp("\\.(" + m.join("|") + ")$", "i")), (y = B.toFixed(2)), (r.isAjaxUpload && C.exists(I)) || r._getFrame(M, !0).length)) {
                                ...
                                return (
                                    ...
                                    void (r.isAjaxUpload
                                        ? (r.duplicateErrors.push(T), (r.isDuplicateError = !0), r._raise("fileduplicateerror", [j, I, R, y, M, w]), a(w + 1), r._updateFileDetails(u))
                                        : (r._showError(T, q), r.unlock(), (u = 0), r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                                );
                            }
                            ...
                            if (!t.isEmpty(f) && t.isArray(f)) {
                                ...
                                if (0 === N) return (T = r.msgInvalidFileType.setTokens({ name: R, types: Z })), void v(T, j, M, w, I);
                            }
                            if (0 === N && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(O) && ((F = t.compare(R, O)), (N += t.isEmpty(F) ? 0 : F.length), 0 === N))
                                return (T = r.msgInvalidFileExtension.setTokens({ name: R, extensions: h })), void v(T, j, M, w, I);
                            if (!r._canPreview(j))
                                return (
                                    (S = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n])),
                                    r.isAjaxUpload && S && C.add(j),
                                    r.showPreview && S && (o.addClass("file-thumb-loading"), r._previewDefault(j), r._initFileActions()),
                            ...
                            (D = $(j.type, R)),
                                ...
                                (n.onload = function (i) {
                                    var a,
                                        ...
                                        m = function () {
                                            ...
                                            (e.onerror = function (e) {
                                                ...
                                                (e.onload = function (e) {
                                                    return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n])
                                                        ? ((H = !0), r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable())
                                                        : (r._previewFile(w, j, e, L, s), r._initFileActions(), void V());
                                                }),
                                                e.readAsDataURL(j);
                                        };
                                    if (
                                        ...
                                        if (
                                            ...
                                            (f = t.getMimeType(a, "", "")),
                                            t.isEmpty(f) && ((u = t.arrayBuffer2String(n.result)), (f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, j.type))),
                                            (s = { name: R, type: f }),
                                            (D = $(f, "")))
                                        )
                                            return void m(z);
                                    ...
                                    return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n])
                                        ? ((H = !0), r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable())
                                        : (r._previewFile(w, j, i, L, s), r._initFileActions(), void V());
                                }),
